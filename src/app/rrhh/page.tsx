  ...
  return (
    <main className="bg-[#EFEFEF]">
      ...
      <div className="content-wrapper">
        <div className="grid pt-36 md:pt-24 pb-20">
          <div className="col-6 md:col-8">
            <h1 className="font-baskerville text-black" style={{ fontSize: 'clamp(36px, 56px, 72px)', lineHeight: 'clamp(40px, 1.3em, 80px)' }}>
              UN EQUIPO QUE<br />
              CRECE EN CADA<br />
              PROYECTO
            </h1>
      ...
      <section className="content-wrapper pb-16">
        ...
        <div className="grid">
          <div className="col-6 md:col-span-5 space-y-6">
          ...
          <div className="col-6 md:col-span-6 md:col-start-7">
            ...
            <div>
              <a 
                ...
                className="font-archivo text-black text-[21px] hover:opacity-70 transition-opacity"
              >
                RRHH@GRUPOFRALI.COM
              </a>
            </div>
